...
function initOsakaTrip() {
    ...
    const POI_DATABASE = [
        ...
        },
        {
            ...
            "desc": "오사카의 상징, 글리코상.",
            "photos": [
                "images/travel/osaka/dotonbori.jpg"
            ],
            "details": {
                "info": "맛집과 네온사인의 거리. 리버크루즈.",
                "transport": "난바역"
            }
        },
        {
        ...
        },
        {
            ...
            "desc": "레트로한 오사카의 분위기.",
            "photos": [
                "images/travel/osaka/shinsekai.jpg"
            ],
            "details": {
                "info": "쿠시카츠(꼬치튀김)의 본고장.",
                "transport": "에비스초역"
            }
        },
        {
            ...
            "desc": "오사카의 부엌.",
            "photos": [
                "images/travel/osaka/kuromon.jpg"
            ],
            "details": {
                "info": "참치, 가리비, 와규 꼬치.",
                "transport": "닛폰바시역"
        ...
        },
        {
            ...
            "region": "namba",
            "rating": 4.7,
            "desc": "세계 기록에 등재된 빛의 거리.",
            "photos": [
                "images/travel/osaka/dotonbori.jpg"
            ],
            "details": {
                "info": "우메다에서 난바까지 4km 구간이 빛으로 연결됩니다.",
                "transport": "미도스지선 각 역",
        ...
        },
        {
            ...
            "region": "tennoji",
            "rating": 4.4,
            "desc": "오사카 명물 복어 요리 전문점.",
            "photos": [
                "images/travel/osaka/fugu_zuboraya.jpg"
            ],
            "details": {
                "info": "커다란 복어 간판이 상징. 코스 요리 추천.",
                "transport": "신세카이 내",
                "tips": "지리는 맑은 탕으로 즐기세요."
            }
        },
        {
            "id": "osaka_castle",
            ...
            "desc": "오사카의 역사적 랜드마크.",
            "photos": [
                "images/travel/osaka/osaka_castle.jpg"
            ],
            "details": {
                "info": "천수각 전망대. 벚꽃 명소.",
                "transport": "오사카조코엔역"
        ...
        },
        {
            ...
            "region": "osaka_castle",
            "rating": 4.5,
            "desc": "천수각을 배경으로 펼쳐지는 빛의 쇼.",
            "photos": [
                "images/travel/osaka/osaka_castle.jpg"
            ],
            "details": {
                "info": "역사적인 성벽에 화려한 영상이 투영됩니다.",
                "transport": "오사카조코엔역",
        ...
        },
        {
            ...
            "desc": "공중 정원 전망대.",
            "photos": [
                "images/travel/osaka/umeda_sky.jpg"
            ],
            "details": {
                "info": "360도 야경. 에스컬레이터.",
                "transport": "오사카역 도보 10분"
            }
        },
        {
            "id": "hep_five",
        ...
        },
        {
            ...
            "desc": "오사카 우동의 원조.",
            "photos": [
                "images/travel/osaka/kitsune_udon.jpg"
            ],
            "details": {
                "info": "달콤한 유부가 올라간 깔끔한 국물.",
                "transport": "도톤보리 내",
                "tips": "국물이 끝내줍니다."
            }
        },
        {
            ...
            "desc": "해리포터와 닌텐도 월드.",
            "photos": [
                "images/travel/osaka/usj.jpg"
            ],
            "details": {
                "info": "익스프레스 패스 필수. 오픈런 추천.",
                "transport": "유니버설시티역"
            }
        },
        {
    ...
    let userItinerary = { "1": ["kix", "swissotel", "dotonbori", "ichiran_dotonbori"], "2": ["usj", "park_front"], "3": ["osaka_castle", "umeda_sky", "hep_five"], "4": ["kuromon", "shinsekai", "kix"] };
    let activeDay = 1;
    let map, markers = [];
