...
function initHakoneTrip() {
    console.log('✨ Hakone App V6.0 Loaded [DEEP DATA]');

    // ==========================================================================
    //  ✨ HIGH FIDELITY DATABASE: HAKONE
    // ==========================================================================
    const POI_DATABASE = [
    {
        "id": "open_air_museum",
    ...
    // ==========================================================================
    let userItinerary = {"1": ["hakone_shrine", "lake_ashi"], "2": ["owakudani", "open_air_museum"], "3": ["yunessun"], "4": ["open_air_museum"]};
    let activeDay = 1;
    let map, markers = [];
...
window.initHakoneTrip = initHakoneTrip;
